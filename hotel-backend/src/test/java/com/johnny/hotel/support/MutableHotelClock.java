...
public class MutableHotelClock extends Clock {
    private volatile Instant current = LocalDate.of(2026,10,1).atTime(14,0).atZone(getZone()).toInstant();
    public void day(int offset) { current = LocalDate.of(2026,10,1).plusDays(offset).atTime(14,0).atZone(getZone()).toInstant(); }
