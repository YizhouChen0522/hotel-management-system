...
class PaymentServiceTest {
    @Mock BookingMapper bookings;@Mock FolioMapper folios;@Mock PaymentMapper payments;@Mock FolioFinancialService financial;@Mock SysAuditLogMapper audits;@Mock com.johnny.hotel.service.support.BillingAccess access;@Mock BusinessDateService businessDates;@Mock com.johnny.hotel.cashier.CashierPostingService cashier;
    PaymentServiceImpl service;
    final String key="123e4567-e89b-12d3-a456-426614174000";
    @BeforeEach void setup(){service=new PaymentServiceImpl(Clock.fixed(Instant.EPOCH,ZoneOffset.UTC),bookings,folios,payments,financial,audits,access,businessDates,cashier);}
