...
class ExpenseIntegrationTest extends IsolatedMysqlTest {
    ...
    @Test void crossFolioSourceAndExpenseIdsRejected(){long b=checkIn();var e=post(b,"SERVICE_CHARGE","10",null);long other=create();var approval=new ApproveBookingRequest();approval.setAssignedRoomId(2L);bookings.approveBooking(other,approval,2L);register(other);bookings.checkIn(other,2L);
