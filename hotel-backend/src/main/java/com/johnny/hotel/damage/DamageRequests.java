package com.johnny.hotel.damage;import jakarta.validation.constraints.*;import lombok.*;import java.math.BigDecimal;public final class DamageRequests{private DamageRequests(){}
 @Data@Builder@NoArgsConstructor@AllArgsConstructor public static class Report{@NotNull private Long stayId;@NotNull private Long assignmentId;@NotNull private DamageSourceType sourceType;@NotNull private Long sourceId;@NotBlank@Size(max=500)private String description;@NotBlank@Size(max=80)private String requestKey;}
