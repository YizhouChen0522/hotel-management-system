...
public class AdminHotelTaskController { private final HotelTaskService service;
 @PostMapping("/{id}/assignees") public Result<TaskView> add(@PathVariable Long id,@Valid @RequestBody TaskRequests.Assign r){return Result.success(service.addAssignees(id,r));}
