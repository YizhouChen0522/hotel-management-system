...
public final class TaskRequests { private TaskRequests(){}
 @Data @Builder @NoArgsConstructor @AllArgsConstructor public static class CreateGeneral { @NotBlank @Size(max=120) private String title; @Size(max=500) private String description; @NotBlank @Size(max=100) private String requestKey; private TaskExecutionType executionType; private List<@NotNull Long> departmentIds; private List<@NotNull Long> assigneeUserIds; }
