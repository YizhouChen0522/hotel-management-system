...
public final class GuestViews {private GuestViews(){}
 ...
 @Builder public record Stay(Long stayId,Long bookingId,Long assignmentId,String roomNumber,String roomTypeName,LocalDateTime actualCheckInTime,LocalDateTime actualCheckOutTime){}
}
