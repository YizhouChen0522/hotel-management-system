...
public class OrganizationController {
 ...
 @GetMapping("/history") public Result<List<OrganizationChangeHistory>> history(@RequestParam(required=false)Integer page,@RequestParam(required=false)Integer size){return Result.success(service.history(page,size));}
